...
from helper_codes import clip_helper, open_ai_helper, aruze_ocr, dbcode, jwt_code, gemini_helper, kfc_ocr, azure_ocr_with_gemini_pro
    ...
    try:
        ...
        if info.checkType == "damage":
            ...
            try:
                ...
                text =await azure_ocr_with_gemini_pro.extract_text_from_image(info.image_url)
                mrp_response, mrp_status=await azure_ocr_with_gemini_pro.product_MRP_extraction(text)
